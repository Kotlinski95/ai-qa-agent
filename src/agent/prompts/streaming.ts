...
/**
 * Generate streaming business answer prompt with website content
 * @param companyName - The company name
 * @param companyDomain - The company domain
 * @param websiteContent - Content from website search
 * @returns Formatted streaming business answer prompt with website content
 */
export function createStreamingBusinessWithWebsitePrompt(
  companyName: string,
...
/**
 * Generate streaming business answer prompt without website content
 * @param companyName - The company name
 * @param companyDomain - The company domain
 * @returns Formatted streaming business answer prompt without website content
 */
export function createStreamingBusinessWithoutWebsitePrompt(
  companyName: string,
  companyDomain: string
): string {
  return `You are a professional AI assistant EXCLUSIVELY for ${companyName} (${companyDomain}).
